...
def chat(messages: list[dict], max_tokens: int = 1024, fast: bool = False, thinking: bool | None = None, model: str | None = None) -> str:
    ...
    """
    model = model or (LLM_MODEL_FAST if fast else LLM_MODEL)
