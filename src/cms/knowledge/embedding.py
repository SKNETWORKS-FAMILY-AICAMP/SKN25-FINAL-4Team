...
The heavy sentence-transformers dependency is intentionally imported lazily so
router/RAG modules remain import-safe when the optional retrieval runtime is not
installed.
"""
