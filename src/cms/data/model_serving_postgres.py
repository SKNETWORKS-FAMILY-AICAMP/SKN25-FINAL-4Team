...
_CONFLICT_KEYS: Mapping[str, tuple[str, ...]] = {
    ...
    "ops.pmax_forecast_inference_log": ("run_id",),
    "qa.pmax_forecast_evaluation": ("evaluation_id",),
    "mart.anomaly_warning_1h": ("meter_urn", "forecast_origin_ts", "lead_step"),
    "ops.anomaly_warning_inference_log": ("run_id",),
    "qa.anomaly_warning_evaluation": ("evaluation_id",),
    "qa.model_serving_evidence_packet": ("packet_id",),
}
