    ...
    def run(
        ...
        *,
        ...
        if peak_feature is not None:
            peak_input = build_peak_input((peak_feature,))
            rows_by_table["peak_feature_15min"] = (_peak_feature_row(peak_feature, safe_test_run_id),)
            rows_by_table["peak_input_15min"] = (_live_table_row(safe_test_run_id, peak_input.bucket_ts, peak_input.meter_urn, peak_input.measurement, peak_input.__dict__),)
