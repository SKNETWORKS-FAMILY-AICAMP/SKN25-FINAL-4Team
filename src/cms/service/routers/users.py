...
_DEFAULT_PASSWORD = os.getenv("CMS_DEMO_DEFAULT_PASSWORD", "change_me")
_passwords: dict[str, str] = {
    "admin@honda-rd.eu": os.getenv("CMS_DEMO_ADMIN_PASSWORD", _DEFAULT_PASSWORD),
    "op_team_a@honda-rd.eu": os.getenv("CMS_DEMO_OPERATOR_PASSWORD", _DEFAULT_PASSWORD),
    "maintenance@honda-rd.eu": os.getenv("CMS_DEMO_MAINTENANCE_PASSWORD", _DEFAULT_PASSWORD),
    "analyst@honda-rd.eu": os.getenv("CMS_DEMO_VIEWER_PASSWORD", _DEFAULT_PASSWORD),
}
