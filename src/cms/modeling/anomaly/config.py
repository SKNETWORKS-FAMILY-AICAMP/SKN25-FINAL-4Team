"""파이프라인 전체 상수 + MeterSpec 정의. anomaly_v84: 잔차(P(t)-P(t-1)) 타겟 실험."""
...
ARTIFACTS_DIR = Path(os.getenv("MODEL_ARTIFACTS_DIR", str(PROJECT_ROOT / "artifacts" / "anomaly"))).resolve()
...
# 전이 실패로 개별 학습 전환된 6개 멤버 (anomaly_v84_member 실험 결과 반영)
