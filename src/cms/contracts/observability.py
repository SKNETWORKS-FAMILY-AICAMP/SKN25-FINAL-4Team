...
DASHBOARD_PANEL_CONTRACTS = (
    ...
    DashboardPanelContract("FastAPI ingest health", "ops.ingest_metric", "ingest request and error rate", "P0"),
    DashboardPanelContract("Kafka consumer lag", "ops.consumer_lag", "consumer group lag", "P0"),
    DashboardPanelContract("Kafka DLQ and produce errors", "ops.latency", "DLQ and produce error counters", "P0"),
    ...
    DashboardPanelContract("Recent blocking issues", "qa.live_issue", "issue triage", "P1"),
    DashboardPanelContract("Latency p95 by stage", "ops.latency", "stage latency", "P0"),
    ...
    DashboardPanelContract("Consumer invariant", "ops.metric", "processed/inserted/duplicate/retry/DLQ reconciliation", "P1"),
)
