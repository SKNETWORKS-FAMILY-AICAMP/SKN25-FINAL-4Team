...
ANOMALY_DETECTION_INFERENCE_LOG_TABLE = "ops.anomaly_log"
ANOMALY_DETECTION_EVALUATION_TABLE = "qa.anomaly_eval"
...
class AnomalyDetectionWideRow:
    ...
    created_at: datetime
    physical_issue_detail: str | None = None
    meter_issue_types: str | None = None
    meter_issue_detail: str | None = None
    meter_issue_severity: str | None = None
    low_sample_t_plus_1: bool = False
    low_sample_t_plus_2: bool = False
    low_sample_t_plus_3: bool = False
...
class AnomalyDetectionLongRow:
    ...
    created_at: datetime
    source_input_refs: tuple[str, ...] = ()
    input_missing_count: int = 0
    input_physical_count: int = 0
    physical_issue_types: str | None = None
    physical_issue_recent_count: int = 0
    physical_issue_pattern: str = "none"
    physical_issue_detail: str | None = None
    meter_issue_types: str | None = None
    meter_issue_detail: str | None = None
    meter_issue_severity: str | None = None
...
def anomaly_wide_to_long_rows(row: AnomalyDetectionWideRow) -> tuple[AnomalyDetectionLongRow, ...]:
    ...
    return tuple(
        AnomalyDetectionLongRow(
            ...
            low_sample=bool(_step_value(row, "low_sample", step)),
        )
        for step in ANOMALY_DETECTION_LEAD_STEPS
    )
