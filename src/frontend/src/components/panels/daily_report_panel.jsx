...
import { Calendar, AlertTriangle, Bot, CheckCircle2, Clock, AlertCircle } from 'lucide-react'
import {
...
export default function DailyReportPanel() {
  ...
  return (
    <div style={s.wrap}>
      ...
      <div style={s.header}>
        <div>
          <div style={{...s.title, display:'flex', alignItems:'center', gap:6}}><Calendar size={14}/>일일 보고서</div>
      ...
      <div style={s.body}>
        ...
        {error && !loading && <div style={{ ...s.placeholder, color: '#f85149', display:'flex', alignItems:'center', gap:5 }}><AlertTriangle size={13}/>{error}</div>}
          ...
          <>
            ...
            {report.ai_summary && (
              <div style={s.summaryBox}>
                <div style={{...s.summaryTitle, display:'flex', alignItems:'center', gap:5}}><Bot size={13}/>AI 일일 브리핑</div>
            ...
            {report.today_actions && (
              <div style={s.actionsBox}>
                <div style={{...s.actionsTitle, display:'flex', alignItems:'center', gap:4}}><CheckCircle2 size={12}/>오늘 할 일</div>
            ...
            <div style={s.chartBox}>
              <div style={{...s.chartTitle, display:'flex', alignItems:'center', gap:4}}><Clock size={12}/>시간대별 전력 프로파일 (kW) · COP</div>
            ...
            <div style={s.chartBox}>
              <div style={s.chartTitle}>
                <AlertCircle size={12} style={{verticalAlign:'-2px',marginRight:4}}/>당일 이상 이벤트
