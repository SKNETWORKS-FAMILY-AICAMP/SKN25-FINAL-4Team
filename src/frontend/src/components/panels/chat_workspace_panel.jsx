    ...
    <div style={s.wrap}>
      ...
      <div style={s.sidebar}>
        <div style={s.sidebarHead}>
          ...
          {sessions.length > 0 && (
            <button onClick={handleClearAll} style={s.clearAllBtn} title="전체 기록 삭제"><Trash2 size={13}/></button>
          )}
        </div>
        <input
          value={search}
        ...
        <div style={s.sessionList}>
          ...
          {sessions.map(sess => (
            ...
            >
              ...
              <button onClick={e => handleDelete(sess.id, e)} style={s.deleteBtn} title="삭제"><X size={10}/></button>
            </div>
          ))}
        </div>
      </div>
