...
async def train_model(
    ...
    """학습 시작 (별도 프로세스). model_name: prophet | xgboost | lstm"""
    import subprocess
...
async def training_status():
    """학습 상태 조회."""
    return {"status": {m: _get_status(m) for m in ("prophet", "xgboost", "lstm")}}
...
async def backtest(
    ...
    df_train = load_range("2018-01-01", train_end + "T23:59:59")
    df_test  = load_range(train_end,    test_end  + "T23:59:59")
