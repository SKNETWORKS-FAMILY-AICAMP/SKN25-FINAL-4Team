"""Export DB-backed training data to parquet archives for RunPod jobs."""
...
from energy_v84.common.config import MeterSpec, training_specs_for_group
...
def export_training_data_archive(
    ...
    *,
    ...
    ``manifest.json``. It is intentionally independent from horizon because the
    same raw hourly frame can train both 1h and 3h models.
    """
