...
| meter_urn | 설명 | 타입 | 에너지 | thermal_mode | anomaly_target | redundant_pair | 비고 |
|---|---|---|---|---|---|---|---|
| V.K21 | 중앙 냉수 공급 메인 | 열량 | 중립 | 냉방 | P | None |  |
| H1.K11 | HVAC 3&5 | 열량 | 중립 | 냉방 | P | None |  |
| H1.K12 | Emission lab HVAC 1/2 | 열량 | 중립 | 냉방 | P | None |  |
| H1.K14 | Emission lab cooling to office | 열량 | 중립 | 냉방 | P | None |  |
| H1.K15 | HVAC 3 | 열량 | 중립 | 냉방 | P | None |  |
| H1.K16 | Server O1 | 열량 | 중립 | 냉방 | P | None |  |
| H2.K21 | Office 냉방 | 열량 | 중립 | 냉방 | P | None |  |
...
| meter_urn | 설명 | 타입 | 에너지 | thermal_mode | anomaly_target | redundant_pair | 비고 |
|---|---|---|---|---|---|---|---|
| H1.W11 | 총 난방 | 열량 | 중립 | 난방 | P | None |  |
| H1.W12 | CHP 열 생산 | 열량 | 중립 | 난방 | P | None | H1 prefix는 physical location / sub-distribution group 의미, CHP thermal side metering |
