...
import ChatWorkspacePanel from './components/panels/ChatWorkspacePanel'
import SimulatorClock    from './components/common/SimulatorClock'
    ...
    <div style={styles.app}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={styles.simBar}>
          ...
          <SimulatorClock onAnomalyClick={() => handleTab('anomaly')} />
        </div>
