...
export default function simulator_clock({ onAnomalyClick } = {}) {
  ...
  return (
    <div style={s.wrap}>
      {/* 시각 디스플레이 */}
      <div style={{ ...s.clock, color: running ? '#3fb950' : 'var(--text3)' }}>
        <span style={{ fontSize: 10, color: 'var(--text4)', marginRight: 6 }}>SIM</span>
...
const s = {
  wrap:        { display: 'flex', alignItems: 'center', gap: 12, padding: '8px 14px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, fontFamily: 'monospace' },
  ...
  btn:         { width: 24, height: 24, padding: 0, background: 'var(--line)', border: '1px solid var(--border)', borderRadius: 4, color: 'var(--text)', fontSize: 11, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  speedBtn:    { padding: '3px 6px', background: 'transparent', border: '1px solid var(--border)', borderRadius: 3, color: 'var(--text3)', fontSize: 10, cursor: 'pointer', fontWeight: 600, fontFamily: 'monospace' },
  speedActive: { background: '#2563eb33', color: '#2563eb', borderColor: '#2563eb66' },

  stats:       { display: 'flex', gap: 8, paddingLeft: 8, borderLeft: '1px solid var(--border)', fontSize: 10, color: 'var(--text3)' },
  ...
  dateInput:   { padding: '2px 4px', background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 4, color: '#2563eb', fontSize: 10, marginLeft: 6, fontFamily: 'monospace', colorScheme: 'light' },
}
