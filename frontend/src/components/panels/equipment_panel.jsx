        ...
        {items.map(it => {
          ...
          return (
            <div key={it.id} style={s.predRow}>
              <span style={{ width: 22, display: 'inline-flex', justifyContent: 'center' }}><equipment_icon id={it.id} size={18} /></span>
    ...
    >
      <div style={s.cardTop}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
          <equipment_icon id={item.id} size={26} />
...
export default function equipment_panel({ onEquipmentClick, onWorkOrderCreated, onFocusEquipment } = {}) {
    ...
    <div style={s.overlay} onClick={onClose}>
      <div style={s.modal} onClick={e => e.stopPropagation()}>
        <div style={s.modalHeader}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <equipment_icon id={item.id} size={24} />
            <div>
