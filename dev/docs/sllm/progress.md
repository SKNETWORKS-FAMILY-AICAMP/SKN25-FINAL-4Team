...
| **Gemma4 12B** ← 채택 | **8.5** | 9.3 | 9.0 | 7.8 | 7.9 | 8.7 | ~8s | **✅** | **품질 경로** |
| GPT-4o (33문항) | 8.1 | 9.2 | 8.4 | 7.1 | 7.6 | 8.1 | ~3s | ❌ | 클라우드 기준선 |
| **EXAONE 3.5 7.8B** ← 채택 | **7.9** | 9.1 | 8.4 | 7.3 | 6.6 | 8.1 | ~3.7s | **✅** | **속도 경로** |
...
**핵심**:
- **Gemma4 12B (9.4 → 8.5)**: 심사 강화 + 프롬프트 v4 적용 후에도 gpt-4o(8.1) 상회 — 채택 결정 유지
- **EXAONE (7.9)**: 33문항 전체 기준. 담당 역할(의도 분류 4문항)만 따로 보면 10.0. 평균 응답 ~3.7s
...
| PV 역률 오진단 | 9.3/10 | **Gemma4 8.0/10** (2026-06-11 v6) | LOW 이상 포함 few-shot + 전압 정상 범위 명시 | 완료 |
