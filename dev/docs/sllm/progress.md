...
| **Gemma4 12B** ← 채택 | **8.6** | 9.4 | 9.1 | 8.1 | 8.0 | 8.6 | ~8s | **✅** | **품질 경로** |
| GPT-4o (33문항) | 8.1 | 9.2 | 8.4 | 7.1 | 7.6 | 8.1 | ~3s | ❌ | 클라우드 기준선 |
| **EXAONE 3.5 7.8B** ← 채택 | **8.1** | 9.1 | 8.6 | 7.6 | 7.0 | 8.1 | ~3.7s | **✅** | **속도 경로** |
...
**핵심 (v8)**:
- **Gemma4 12B (8.4 → 8.6)**: provided_data 정비 + 프롬프트 재설계로 근거성 7.7→8.1, 논리성 7.5→8.0 향상. data_missing 5.0→9.4 극적 개선
- **EXAONE (7.9 → 8.1)**: intent_multi 10.0 달성, cms_critical 5.8→7.6, data_missing 5.0→8.0 개선. 담당 역할(의도 분류 4문항)만 따로 보면 10.0. 평균 응답 ~3.7s
