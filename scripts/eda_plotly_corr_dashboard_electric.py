...
LONG_CSV_PATHS = {
    "6year": PROJECT_ROOT / "outputs" / "raw_eda" / "correlation" / "static" / "csv" / "electric" / "6year" / "long.csv",
    "yearly": PROJECT_ROOT / "outputs" / "raw_eda" / "correlation" / "static" / "csv" / "electric" / "yearly" / "long.csv",
    "seasonal": PROJECT_ROOT / "outputs" / "raw_eda" / "correlation" / "static" / "csv" / "electric" / "seasonal" / "long.csv",
}
VIEW_LABELS = {
    "6year": "6-Year",
    "yearly": "Yearly",
...
<body>
  <div class="wrap">
    <div class="panel">
      ...
      <p>기존 raw correlation 산출물을 하나의 Heatmap 뷰어로 통합했습니다.</p>
      <div class="controls">
        <div>
