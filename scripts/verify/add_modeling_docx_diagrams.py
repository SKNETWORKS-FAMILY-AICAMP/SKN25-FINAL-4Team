...
SOURCE_DIAGRAM_DIR = Path('/home/viowlet/Projects/CMS/docs/diagrams')
...
# Use the existing canonical project diagrams under docs/diagrams.
# Only PNG renderings are generated for DOCX embedding.
DOCS = {
    'ai_system_architecture': {
        'docx': FINAL_DIR / 'ai_system_architecture.docx',
        'source_svg': SOURCE_DIAGRAM_DIR / 'flow/00_overall.svg',
        'png': DIAGRAM_DIR / '00_overall_flow.png',
        'anchor': '1. 에이전트 설계 개요',
    ...
    'multi_agent_test_report': {
        ...
        'source_svg': SOURCE_DIAGRAM_DIR / 'seq/00_overall.svg',
        'png': DIAGRAM_DIR / '00_overall_seq.png',
    ...
    'vector_graph_db_result': {
        ...
        'source_svg': SOURCE_DIAGRAM_DIR / 'flow/01_db.svg',
        'png': DIAGRAM_DIR / '01_db_flow.png',
