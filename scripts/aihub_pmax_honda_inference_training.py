...
VAL_BASE = Path.home() / "SKN25-FINAL-4Team/149.전력_설비_에너지_품질/01.데이터/1.Training/라벨링데이터/1.펌프_일반모터/2.SOH진단/1.역률평균/0.Combined"
OUT_PATH = Path.home() / "SKN25-FINAL-4Team/outputs/aihub_pmax_honda_inference_training_per_device.csv"
...
print(f"Training 설비: {len(val_ids)}개")
...
for device_id in tqdm(val_ids, desc="설비별 추론(Training)"):
