...
expected_table_privileges(role_name, schema_name, table_name, privilege) AS (
    VALUES
        ...
        ('cms_model_serving_runtime', 'ops', 'pmax_forecast_inference_log', 'SELECT'),
        ('cms_model_serving_runtime', 'ops', 'pmax_forecast_inference_log', 'INSERT'),
        ('cms_model_serving_runtime', 'ops', 'pmax_forecast_inference_log', 'UPDATE'),
        ('cms_model_serving_runtime', 'ops', 'anomaly_warning_inference_log', 'SELECT'),
        ('cms_model_serving_runtime', 'ops', 'anomaly_warning_inference_log', 'INSERT'),
        ('cms_model_serving_runtime', 'ops', 'anomaly_warning_inference_log', 'UPDATE'),
        ('cms_model_serving_runtime', 'qa', 'pmax_forecast_evaluation', 'SELECT'),
        ('cms_model_serving_runtime', 'qa', 'pmax_forecast_evaluation', 'INSERT'),
        ('cms_model_serving_runtime', 'qa', 'pmax_forecast_evaluation', 'UPDATE'),
        ('cms_model_serving_runtime', 'qa', 'anomaly_warning_evaluation', 'SELECT'),
        ('cms_model_serving_runtime', 'qa', 'anomaly_warning_evaluation', 'INSERT'),
        ('cms_model_serving_runtime', 'qa', 'anomaly_warning_evaluation', 'UPDATE'),
        ('cms_model_serving_runtime', 'qa', 'model_serving_evidence_packet', 'SELECT'),
        ('cms_model_serving_runtime', 'qa', 'model_serving_evidence_packet', 'INSERT'),
        ('cms_model_serving_runtime', 'qa', 'model_serving_evidence_packet', 'UPDATE'),
        ('cms_model_serving_reference_read', 'reference', 'corrected_resampled_15min', 'SELECT'),
        ('cms_model_serving_reference_read', 'reference', 'corrected_resampled_1h', 'SELECT')
),
