...
GRANT SELECT, INSERT, UPDATE ON TABLE ops.pmax_log TO cms_model_serving_runtime;
GRANT SELECT, INSERT, UPDATE ON TABLE ops.anomaly_log TO cms_model_serving_runtime;
GRANT SELECT, INSERT, UPDATE ON TABLE qa.pmax_eval TO cms_model_serving_runtime;
GRANT SELECT, INSERT, UPDATE ON TABLE qa.anomaly_eval TO cms_model_serving_runtime;
GRANT SELECT, INSERT, UPDATE ON TABLE qa.serving_evidence TO cms_model_serving_runtime;
...
GRANT SELECT ON TABLE reference.corrected_15min TO cms_model_serving_reference_read;
GRANT SELECT ON TABLE reference.corrected_1h TO cms_model_serving_reference_read;
