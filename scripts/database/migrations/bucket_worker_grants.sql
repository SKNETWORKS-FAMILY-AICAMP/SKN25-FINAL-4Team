...
GRANT SELECT ON TABLE mart.peak_feature_15min TO cms_ingest;
GRANT SELECT ON TABLE ops.exclusion_window TO cms_ingest;
...
SELECT
    ...
    has_table_privilege('cms_ingest', 'mart.peak_feature_15min', 'SELECT') AS active_peak_select,
