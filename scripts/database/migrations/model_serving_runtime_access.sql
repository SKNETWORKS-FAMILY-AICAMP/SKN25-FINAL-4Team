...
GRANT SELECT, INSERT, UPDATE ON TABLE ops.metric TO cms_ingest;
...
GRANT SELECT, INSERT ON TABLE qa.live_issue TO cms_ingest;
...
GRANT SELECT ON TABLE mart.peak_feature_15min TO cms_model_serving;
GRANT SELECT ON TABLE ops.exclusion_window TO cms_model_serving;
GRANT SELECT ON TABLE mart.peak_feature_15min TO cms_model_serving;
...
GRANT SELECT, INSERT, UPDATE ON TABLE ops.pmax_log TO cms_model_serving;
GRANT SELECT, INSERT, UPDATE ON TABLE qa.pmax_eval TO cms_model_serving;
GRANT SELECT, INSERT, UPDATE ON TABLE mart.anomaly_warning_1h TO cms_model_serving;
GRANT SELECT, INSERT, UPDATE ON TABLE ops.anomaly_log TO cms_model_serving;
GRANT SELECT, INSERT, UPDATE ON TABLE qa.anomaly_eval TO cms_model_serving;
GRANT SELECT, INSERT, UPDATE ON TABLE qa.serving_evidence TO cms_model_serving;
