...
-- mart.peak_feature_15min table, mart.pmax_forecast_15min,
-- ops.pmax_log, and qa.pmax_eval are present.
-- Required active: mart.anomaly_feature_1h,
-- mart.anomaly_warning_1h, ops.anomaly_log,
-- qa.anomaly_eval, qa.serving_evidence.
...
-- P-Max input is mart.peak_feature_15min only; do not create active_peak, peak_input, or training_frame aliases.
...
CREATE TABLE IF NOT EXISTS qa.pmax_eval (
    ...
    CONSTRAINT pmax_eval_values_check CHECK (
...
CREATE TABLE IF NOT EXISTS ops.anomaly_log (
    run_id TEXT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS qa.anomaly_eval (
...
CREATE TABLE IF NOT EXISTS qa.serving_evidence (
