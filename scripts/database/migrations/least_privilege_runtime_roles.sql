...
GRANT SELECT, INSERT, UPDATE ON TABLE ops.pipeline_metric TO cms_runtime_ingest_role;
GRANT SELECT, INSERT ON TABLE qa.bad_row TO cms_runtime_ingest_role;
GRANT SELECT, INSERT ON TABLE qa.live_measurement_issue TO cms_runtime_ingest_role;
